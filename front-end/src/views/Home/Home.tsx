...
export default function Home() {
    ...
    const values = resources?.map(({id, author, category, name, createdAt, content}) => (
        <Resource key={id} title={name} category={category} author={author} created={createdAt} resource={content}/>));
